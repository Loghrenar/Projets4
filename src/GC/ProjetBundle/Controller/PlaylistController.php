...
use GC\ProjetBundle\Entity\Playlist;
use GC\ProjetBundle\Form\PlaylistType;
...
class PlaylistController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GCProjetBundle:Playlist')->findAll();
     ...
     * @Method("POST")
     * @Template("GCProjetBundle:Playlist:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('gc_playlist_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Playlist $entity)
    {
        $form = $this->createForm(new PlaylistType(), $entity, array(
            'action' => $this->generateUrl('gc_playlist_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GCProjetBundle:Playlist')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new PlaylistType(), $entity, array(
            'action' => $this->generateUrl('gc_playlist_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("GCProjetBundle:Playlist:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('gc_playlist_delete', array('id' => $id)))
            ->setMethod('DELETE')
